...
class TransactionRestControllerTest {
    ...
    void givenMissingInput_whenMakeTransfer_thenVerifyBadRequest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/transactionsapi/transactions")
    ...
    void givenInvalidInput_whenMakeTransfer_thenVerifyBadRequest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/transactionsapi/transactions")
                .content("{\"accountNumber\": \"73084635\" }, \"targetAccount\": {\"sortCode\": \"65-93-37\", \"accountNumber\": \"21956204\"}, \"amount\": -10}")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    void givenNoAccountForInput_whenMakeTransfer_thenVerifyOk() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/transactionsapi/transactions")
                .content("{\"accountNumber\": \"73084635\"}, \"targetAccount\": {\"sortCode\": \"65-93-37\", \"accountNumber\": \"21956204\"}, \"amount\": 105.0, \"reference\": \"My ref\", \"latitude\": 66.23423423, \"longitude\": 105.234234}")
                .contentType(MediaType.APPLICATION_JSON))
